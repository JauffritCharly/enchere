...
public class methodSQL {
    ...
    public void insertNouvelleConnection(String pseudo, String nom, String prenom, String email, String telephone, String rue, int codePostal, String ville, String motDePasse, String confirmPassWord) {
